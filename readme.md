Create a mixed technique portrait bold and expressive using the face of my uploaded photo as a base. The portrait must be a first plane, 
with a frontal pose with an inclination of the chin slightly upwards to convey confidence, attitude and artistic intensity. 
The general aesthetic must reflect a gritty, hand-drawn, graffiti-meets-urban-journal style mixing chaotic lines of pencil strokes, technical designs inspired by vectors and brushstrokes.


---


Uma cena cinematográfica hiper-realista em resolução 8K, mostrando uma gigantesca estátua de pedra inacabada, parcialmente esculpida, erguendo-se no meio de um canteiro de obras movimentado. 
O rosto da estátua deve ser esculpido com base fiel na foto fornecida, mantendo as características reais da pessoa: formato do rosto, expressão, olhos, boca e detalhes faciais. Ao redor, 
operários indonésios usando capacetes amarelos trabalham entre andaimes, entulhos de pedra, poeira e maquinário pesado como guindastes. 
O céu está nublado e dramático, com iluminação suave e sombria, criando profundidade e atmosfera cinematográfica. 
Ao fundo, o horizonte de uma cidade moderna aparece em desfoque, acrescentando contexto urbano.


----


Crie uma ilustração 3D em estilo cartoon realista de um(a) [insira aqui: homem ou mulher] com expressão sorridente, saindo da parte superior de uma moldura que imita o design do Instagram.
A moldura está dinamicamente rasgada, como se o personagem estivesse rompendo a tela, emergindo apenas com a parte superior do corpo (sem pernas ou pés visíveis).
No topo da moldura, inclua:
Nome de usuário: [@seuusuario]
Seguidores: [ex: 10k seguidores]
Foto de perfil: [use a imagem
carregada como referência visuali
O personagem possui as seguintes características físicas:
[Descreva aqui: cor da pele, tipo e cor do cabelo, cor dos olhos, outros traços marcantes]
E está vestindo:
[Descreva aqui: exemplo, jaqueta jeans azul, camiseta preta básica, acessórios se houver]
A mão direita está levantada em forma de aceno, com o restante do corpo ainda dentro da moldura.
